...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
    <ul>
        ...
        <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Menu Category</span> <span class="label label-important">2</span></a>
            <ul <?php if (preg_match("/categor/i", $url)){ ?> style="display: block;" <?php } ?>>
                <li <?php if (preg_match("/add-category/i", $url)){ ?> class="active" <?php } ?>><a href="{{ url('/admin/add-category')}}">Add Menu Category</a></li>
                <li <?php if (preg_match("/view-categories/i", $url)){ ?> class="active" <?php } ?>><a href="{{ url('/admin/view-categories')}}">View Menu Category</a></li>
            </ul>
        </li>
        <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Menu Items</span> <span class="label label-important">2</span></a>
            <ul <?php if (preg_match("/item/i", $url)){ ?> style="display: block;" <?php } ?>>
                <li <?php if (preg_match("/add-item/i", $url)){ ?> class="active" <?php } ?>><a href="{{ url('/admin/add-item')}}">Add Menu Item</a></li>
                <li <?php if (preg_match("/view-items/i", $url)){ ?> class="active" <?php } ?>><a href="{{ url('/admin/view-items')}}">View Menu Item</a></li>
            </ul>
        </li>
