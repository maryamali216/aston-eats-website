...
@section('content')
    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="/admin/dashboard" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Orders</a> <a href="/admin/view-orders" class="current">View Orders</a> </div>
            <h1>Orders</h1>
